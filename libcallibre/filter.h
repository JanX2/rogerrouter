...
#ifndef LIBCALLIBRE_FILTER_H
#define LIBCALLIBRE_FILTER_H
...
enum {
	JOURNAL_TYPE_CALL_TYPE = 0,
	JOURNAL_TYPE_DATE_TIME,
	JOURNAL_TYPE_REMOTE_NAME,
	JOURNAL_TYPE_REMOTE_NUMBER,
	JOURNAL_TYPE_LOCAL_NAME,
	JOURNAL_TYPE_LOCAL_NUMBER
};
