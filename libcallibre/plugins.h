...
#ifndef LIBCALLIBRE_PLUGINS_H
#define LIBCALLIBRE_PLUGINS_H
 ...
 *
 * Registers a plugin with the Callibre plugin system, including registering the type specified in the parameters and declaring its activate and
 * deactivate functions.
 **/
#define _CALLIBRE_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name, TYPE_CODE, REGISTER_CODE)	\
	typedef struct {							\
 ...
 * deactivate functions.
 **/
#define CALLIBRE_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name)			\
	_CALLIBRE_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name,,)

/**
 * CALLIBRE_PLUGIN_REGISTER_CONFIGURABLE:
 * \param TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * \param TypeName: the name of the plugin type, in CamelCase
 * \param type_name: the name of the plugin type, in lower_case
 *
 * Registers a configurable plugin with the Callibre plugin system, including registering the type specified in the parameters and declaring its activate
 * and deactivate and widget creation functions.
 **/
#define CALLIBRE_PLUGIN_REGISTER_CONFIGURABLE(TYPE_NAME, TypeName, type_name)	\
...
void callibre_plugins_add_search_path(gchar *path);
