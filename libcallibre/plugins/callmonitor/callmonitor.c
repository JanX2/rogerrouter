...
#define CALLIBRE_TYPE_CALLMONITOR_PLUGIN (callibre_callmonitor_plugin_get_type ())
#define CALLIBRE_CALLMONITOR_PLUGIN(o) (G_TYPE_CHECK_INSTANCE_CAST((o), CALLIBRE_TYPE_CALLMONITOR_PLUGIN, CallibreCallMonitorPlugin))
...
typedef struct {
	...
	GIOChannel *channel;
	guint id;
} CallibreCallMonitorPluginPrivate;

CALLIBRE_PLUGIN_REGISTER(CALLIBRE_TYPE_CALLMONITOR_PLUGIN, CallibreCallMonitorPlugin, callibre_callmonitor_plugin)
...
{
	CallibreCallMonitorPlugin *callmonitor_plugin = user_data;
	GSocket *socket;
...
{
	CallibreCallMonitorPlugin *callmonitor_plugin = CALLIBRE_CALLMONITOR_PLUGIN(plugin);
