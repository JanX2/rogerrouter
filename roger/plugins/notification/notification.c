...
#define CALLIBRE_TYPE_NOTIFICATION_PLUGIN (callibre_notification_plugin_get_type ())
#define CALLIBRE_NOTIFICATION_PLUGIN(o) (G_TYPE_CHECK_INSTANCE_CAST((o), CALLIBRE_TYPE_NOTIFICATION_PLUGIN, CallibreNotificationPlugin))

typedef struct {
        guint signal_id;
} CallibreNotificationPluginPrivate;

CALLIBRE_PLUGIN_REGISTER_CONFIGURABLE(CALLIBRE_TYPE_NOTIFICATION_PLUGIN, CallibreNotificationPlugin, callibre_notification_plugin)
...
{
	CallibreNotificationPlugin *notify_plugin = CALLIBRE_NOTIFICATION_PLUGIN(plugin);
